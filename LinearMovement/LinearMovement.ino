...
int vel = 9;
int incomingByte = 0;
bool pointForward = false;
bool pointBackward = false;
int pointCounter = 0;
void setup() {
    Serial.begin(57600);
    pinMode(12, OUTPUT);
    ...
    motor2.changeMode(1);
    motor3.changeMode(1);
    motor4.changeMode(16);
    delay(2);
    motor5.changeMode(16);
    delay(2);
    motor1.action();
    motor2.action();
    motor3.action();
    ...
    motor3.action();
    motorChange(true);
    motor2.setPID(1300,300,800);
    motor3.setPID(1300,300,800);
    //gotoPoint(490,0);
    motorChange(false);
    delay(3001);
    openGrippers();
...
void gotoPoint (int x, int y){
  int newTheta = getTheta(x, y);
  int newTheta2 = getTheta2(x, y);
  motor2.goalPos(newTheta+90);
  motor2.action();
  motor3.goalPos(newTheta2+90);
  motor3.action();
